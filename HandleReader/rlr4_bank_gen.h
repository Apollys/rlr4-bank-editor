...
namespace bankgen {
    ...
    std::vector<int> decode_account_data(const std::string &input_string);
    std::string encode_runling_data(std::vector<int> &data);
    std::vector<int> decode_runling_data(const std::string &input_string);
    std::string encode_slots_data(std::vector<int> &data);
    std::string encode_checksums(int account_checksum, int character_checksum);
    void decode_checksums(const std::string& input_string, int* account_checksum, int* character_checksum);
